...
**最后更新**：2026-09-21（round 12：**评估通道 M1/M2/M4 收口五层**（提交 `25fe40c` + 推送 + pin 推进；方案档新增 §10 施工进度总表）；
**新增 §0q 登记 MCL 幂等闸竞态的真机取证** —— 该条**推翻了方案档「E-05 真机未撞上」的记载**：实测 1859 组 / 3997 次多跑判定、
**当日仍在发生**；已取证、**未修**（修它要动冻结件，抬基线属 R3）；另按取证订正方案档 A3 判据的真机态）
...
## 0q. 🔴 **MCL 幂等闸竞态：「窗口存在但真机未撞上」的旧记载被推翻 —— 今日仍在发生（3997 次多跑判定 / 1655 会话）**（2026-09-21 round 12 · **已取证，未修**）
