...
> 状态：2026-09-09 用户拍板开工。目标=「跑在个人电脑上的全能助理」；边界=伙伴向不做（2026-09-13 P5 澄清：伙伴能力归**另一插件**，守藏只做长期记忆底座）。
...
- **定位**：跑在个人电脑上的全能助理——能执行（文件/命令/代码）、能联网（检索/抓取/验证）、能记忆与自我认知、越用越强。**伙伴向不做**（归另一插件）。守藏自身定位 = **长期记忆底座**（服务助理的记忆能力），不是"本插件是助理"——口径见 `docs/context-supply-plan.md` §5。
