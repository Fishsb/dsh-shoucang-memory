...
export function applyPanel(ctx, config) {
    ...
    const buildHotMemoryText = () => {
        ...
        if (!userLines.length && !memLines.length && !principleLines.length) {
            injectCache.text = '';
            return '';
        }
    ...
    const memoryCaps = (base) => {
        const out = { 'MEMORY.md': 3000, 'USER.md': 2000, 'AGENT.md': 2000, 'PRINCIPLES.md': 1000 };
        try {
