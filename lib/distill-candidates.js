...
export function createCandApi(d) {
    return {
        intentOf: (...a) => intentOf(d, ...a),
        intentTokens: (...a) => intentTokens(d, ...a),
        cardTokens: (...a) => cardTokens(d, ...a),
        cardSimilar: (...a) => cardSimilar(d, ...a),
        ensureFlowCandidate: (...a) => ensureFlowCandidate(d, ...a),
    };
}
...
const ensureFlowCandidate = async (d, sid, intent) => {
...
//# sourceMappingURL=distill-candidates.js.map