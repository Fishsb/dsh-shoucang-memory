...
export function createDistillPaths() {
    ...
    //   保留期（EPISODE_CAP）改由 `ledger-compact.ts` 的**按 type 裁剪**承担——只删 episode 的旧行，
    //   其他 type 的行原样保留；旧做法是重写整个文件 ⇒ 并进共享台账会**截断全表**。
    const episodeFile = join(kRoot, 'audit', 'ledger.jsonl');
...
//# sourceMappingURL=distill-paths.js.map