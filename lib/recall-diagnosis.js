...
export function isAttributionRow(row) {
 ...
 */
export function takeAttributionScan(rawsDescending, parse, pred, limit, maxScan = ATTRIBUTION_MAX_SCAN) {
    const rows = [];
    let scanned = 0;
