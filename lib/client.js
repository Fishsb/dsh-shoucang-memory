  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      function mountSidebarEntry() {
        ...
        // 插入：与设置同容器（settingsArea 内设置按钮前），保持宿主排版
        var insertTarget = settingsBtn ? (settingsBtn.parentElement || foot) : foot;
        if (settingsBtn && settingsBtn.parentElement) insertTarget.insertBefore(btn, settingsBtn);
        else foot.insertBefore(btn, foot.firstChild); // 回退：foot 首行
