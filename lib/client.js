...
`;
  ...
  function ovMorningCard() {
    var card = UI.card(tr("\u6668\u8D77\u6458\u8981"), { right: [el("span", "sc-src", "/memory/overview \xB7 delta / weekDiff")] });
    var box = el("div");
    ...
    appState.api("/memory/overview").then(function(d3) {
      ...
      if (sub) {
        if (dl.present && dl.staleAt) {
          ...
          sub.textContent = tr("delta \xB7 \u5269\u4F59 ") + (h3 > 0 ? h3 + "h" : tr("\u5DF2\u8FC7\u671F")) + tr(" \u6709\u6548");
      ...
      rows.forEach(function(t6, i7) {
        box.appendChild(ovCRow(String(t6), tr("\u6765\u6E90\uFF1Adelta.md"), [
          i7 === 0 ? ovPill("injections " + Derive.num(dl.injections || 0), null, true) : ovPill("delta", "info")
        ]));
      });
      var n6 = Number(wd.deepAdded || 0);
      box.appendChild(ovCRow(tr("\u8FD1 7 \u5929\u6DF1\u7761\u65B0\u4E60\u5F97 ") + Derive.num(n6) + tr(" \u6761"), "weekDiff.deepAdded", [ovPill("+" + Derive.num(n6), "ok")]));
    }).catch(function() {
      box.textContent = "";
      box.appendChild(el("div", "sc-desc", tr("\u6668\u8D77\u6458\u8981\u8BFB\u53D6\u5931\u8D25\uFF08/memory/overview\uFF09\u3002")));
    });
    return card.box;
  }
  ...
  function mmPendingRows(ctx) {
    ...
    if (data.pending && data.pending.count) {
      group(tr("pending \u5019\u9009\u961F\u5217 \xB7 ") + data.pending.count + tr(" \u6761"));
      ...
      (data.pending.recent || []).forEach(function(p22) {
        ...
        okBtn.addEventListener("click", function() {
          appState.api("/memory/approve", { method: "POST", body: JSON.stringify({ pendingFile: fname }) }).then(function() {
            appState.statusFn(tr("\u2713 \u5DF2\u6279\u51C6 ") + fname + tr("\uFF08\u79FB .processed\uFF0C\u5185\u5BB9\u7531\u84B8\u998F\u6B63\u5E38\u5165\u518C\uFF09"));
          }).catch(appState.failFn);
        });
        var rmBtn = UI.button(tr("\u5FFD\u7565"), function() {
          return appState.api("/memory/approve", { method: "POST", body: JSON.stringify({ pendingFile: fname }) }).then(function() {
            appState.statusFn(tr("\u5DF2\u5FFD\u7565 ") + fname);
          });
      ...
      host.appendChild(el("div", "sc-desc", tr("\u5171 ") + data.pending.count + tr(" \u6761\uFF08\u4EC5\u663E\u793A\u6700\u8FD1 ") + Derive.count(data.pending.recent) + tr(" \u6761\uFF09\xB7 \u6279\u51C6=\u786E\u8BA4\u6709\u4EF7\u503C\u5165\u518C\uFF0C\u5FFD\u7565=\u79FB\u51FA\u961F\u5217")));
  ...
  function renderTogglesModelLlm(host) {
    ...
    function renderLlmSelect(container, keyP, keyM, label, desc) {
      ...
      function rebuild() {
        ...
        optMain.value = "";
        optMain.textContent = tr("\u8DDF\u968F\u4E3B\u6A21\u578B\uFF08\u9ED8\u8BA4\uFF09");
      ...
      sel.addEventListener("change", function() {
        ...
        appState.api("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
          appState.statusFn("\u2713 " + label + tr(" \u5DF2\u8BBE") + (v2 ? "\uFF1A" + v2 : tr("\uFF08\u8DDF\u968F\u4E3B\u6A21\u578B\uFF09")) + tr("\u2014\u2014\u91CD\u8F7D\u540E\u751F\u6548"));
        }).catch(appState.failFn);
      });
      rebuild();
    ...
    function renderLlmCard() {
      ...
      note.textContent = hostModels ? tr("\u5BBF\u4E3B\u53EF\u7528 ") + hostModels.length + tr(" \u4E2A\u6A21\u578B") : tr("\u8BFB\u53D6\u5BBF\u4E3B\u6A21\u578B\u2026");
  ...
  var EN = {
    ...
    "\u84B8\u998F\u4E0E\u6DF1\u5EA6\u7761\u7720\u5404\u81EA\u53EF\u9009\u5BBF\u4E3B\u6A21\u578B\uFF08\u76F4\u63A5\u7528 DeepSeek Harness \u6A21\u578B\u2014\u2014\u5148\u5728 Harness \u914D\u7F6E\u597D\u6A21\u578B\uFF0C\u8FD9\u91CC\u4E0B\u62C9\u9009\u5373\u53EF\uFF09\u3002\u300C\u7EE7\u627F\u4E3B\u4F1A\u8BDD\u300D= \u4E0D\u6307\u5B9A\uFF0C\u8DDF\u968F\u5F53\u524D\u4F1A\u8BDD\u6A21\u578B\u3002\u6539\u52A8\u5199 scheduler.json\uFF0C\u9700\u91CD\u8F7D\u751F\u6548\u3002": `Distillation and deep sleep can each select a host model (use DeepSeek Harness models directly \u2014 configure the model in Harness first, then pick it from the dropdown here). "Inherit main session" = unspecified, following the current session's model. Changes are written to scheduler.json and take effect after reload.`,
  ...
  var EN2 = {
    ...
    " \u5B57\uFF09": " chars)",
    " \u6761\u3002": " items.",
    " \u6761\uFF08\u4EC5\u663E\u793A\u6700\u8FD1 ": " items (showing only the latest ",
    " \u6761\uFF09\xB7 \u6279\u51C6=\u786E\u8BA4\u6709\u4EF7\u503C\u5165\u518C\uFF0C\u5FFD\u7565=\u79FB\u51FA\u961F\u5217": " items) \xB7 Approve = confirm it is worth filing, Ignore = remove from the queue",
    " \u6B21": " times",
    ...
    "pending \u5019\u9009\u961F\u5217 \xB7 ": "pending candidate queue \xB7 ",
    ...
    "\u5FFD\u7565": "Ignore",
    "\u5FFD\u7565\u4E2D\u2026": "Ignoring\u2026",
    "\u5FFD\u7565\u5E76\u79FB\u51FA\u5019\u9009\u961F\u5217\uFF1A": "Ignore and remove from the candidate queue:",
    "\u6210\u529F ": "Succeeded ",
    "\u6279\u51C6": "Approve",
    ...
    "\uFF08\u79FB .processed\uFF0C\u5185\u5BB9\u7531\u84B8\u998F\u6B63\u5E38\u5165\u518C\uFF09": "(moved to .processed; the content is filed normally by distillation)",
    "\uFF08\u7A7A\u5C0F\u8282\uFF09": "(empty section)",
  ...
  var EN5 = {
    ...
    "delta \xB7 \u5269\u4F59 ": "delta \xB7 remaining ",
