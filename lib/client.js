  ...
  window.__ModuleLoader__.load({
    ...
    factory: function (require) {
      ...
      var CSS = [
        ...
        '#scpanl-root .sc-hidden{display:none !important;}',
        /* 滚动条（WebKit + Firefox 双写） */
        '#scpanl-root .sc-view,#scpanl-root .sc-logwrap,#scpanl-root .sc-card-body,#scpanl-root .sc-scroll-y,#scpanl-root .sc-nav{',
        ...
        /* 文本工具 */
        '#scpanl-root .sc-ellipsis{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;min-width:0;}',
        '#scpanl-root .sc-clamp-2{display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;}',
        '#scpanl-root .sc-clamp-3{display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;}',
        '#scpanl-root .sc-break{overflow-wrap:anywhere;word-break:break-word;}',
        '#scpanl-root .sc-scroll-y{overflow-y:auto;overscroll-behavior:contain;}',
        ...
        'padding:5px 10px;min-height:30px;outline:none;',
        ...
        '#scpanl-root .sc-prog-fill{height:100%;width:0;border-radius:var(--sc-r-pill);background:var(--sc-accent);',
        ...
        /* 边界态：空 / 加载 / 溢出 */
        '#scpanl-root .sc-empty{display:flex;flex-direction:column;align-items:center;justify-content:center;',
        'gap:var(--sc-sp-2);padding:var(--sc-sp-6) var(--sc-sp-4);color:var(--sc-muted);text-align:center;}',
        '#scpanl-root .sc-empty-icon{opacity:.5;}',
        '#scpanl-root .sc-empty-title{font-size:var(--sc-fs-md);font-weight:var(--sc-fw-semibold);color:var(--sc-text);}',
        '#scpanl-root .sc-empty-desc{font-size:var(--sc-fs-sm);color:var(--sc-muted);max-width:42ch;',
        ...
        '#scpanl-root .sc-spinner{display:inline-block;width:13px;height:13px;flex:none;vertical-align:-2px;',
        'border:2px solid var(--sc-border);border-top-color:var(--sc-accent);border-radius:50%;',
        ...
        '#scpanl-root .sc-mem-sub.mono{font-family:ui-monospace,Menlo,Consolas,monospace;',
        'font-size:var(--sc-fs-xs);color:var(--sc-faint);}',
        ...
        /* 向量 / 模型配置 */
        '#scpanl-root .sc-vec-group{border:1px solid var(--sc-border);border-radius:var(--sc-r-md);',
        'padding:2px var(--sc-sp-4) var(--sc-gap-item);margin:0 0 var(--sc-gap-item);background:var(--sc-bg2);}',
        '#scpanl-root .sc-vec-group-h{font-size:var(--sc-fs-xs);font-weight:var(--sc-fw-semibold);',
        'letter-spacing:var(--sc-ls-wide);color:var(--sc-faint);text-transform:uppercase;',
        'margin:var(--sc-gap-row) 0 2px;}',
        '#scpanl-root .sc-vec-row{display:flex;align-items:center;gap:var(--sc-gap-row);min-width:0;}',
        '#scpanl-root .sc-vec-cell{flex:1;min-width:0;display:flex;flex-direction:column;gap:2px;}',
        '#scpanl-root .sc-vec-label{font-size:var(--sc-fs-sm);color:var(--sc-text);max-width:480px;',
        'overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}',
        '#scpanl-root .sc-vec-progress{font-size:var(--sc-fs-xs);color:var(--sc-accent);max-width:340px;',
        'overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-variant-numeric:tabular-nums;}',
        '#scpanl-root .sc-vec-status{flex:none;max-width:300px;overflow:hidden;text-overflow:ellipsis;',
        'white-space:nowrap;font-size:var(--sc-fs-xs);color:var(--sc-muted);margin-left:auto;}',
        '#scpanl-root .sc-vec-ctrl{display:flex;align-items:center;gap:6px;flex:none;}',
