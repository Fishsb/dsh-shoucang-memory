    ...
    window.__ModuleLoader__.load({
      ...
      factory: function(require2) {
        ...
        function deferFold(host, mark, label, openDefault, key) {
          _foldQueue.push({ host, mark, label, open: !!openDefault, key });
        }
        function flushFolds() {
          var q = _foldQueue;
          _foldQueue = [];
        ...
        function numSetting(name, desc, val, key, unit, step) {
          ...
          inp.onchange = function() {
            ...
            api("/set", { method: "POST", body: JSON.stringify({ key, value: v2 }) }).then(function() {
              status2("\u2713 " + key + " = " + v2);
            }).catch(fail2);
          };
        ...
        function renderTogglesInject(host, view, parsed, g2) {
          ...
          PERSONA_TIERS.forEach(function(tier, i7) {
            ...
            cell.onclick = function() {
              api("/set", { method: "POST", body: JSON.stringify({ key: "injection.persona", value: tier[0] }) }).then(function() {
          ...
          SWITCH_KEYS.forEach(function(it) {
            ...
            host.appendChild(makeToggle(it[0], it[1], it[2], cur, function(key, sw) {
              api("/toggle", { method: "POST", body: JSON.stringify({ key }) }).then(function() {
                status2("\u2713 \u5DF2\u5207\u6362 " + key);
              }).catch(function(e8) {
                fail2(e8);
          ...
          LEVEL_TIERS.forEach(function(tier, i7) {
            ...
            cell.onclick = function() {
              api("/set", { method: "POST", body: JSON.stringify({ key: "injection.level", value: tier[0] }) }).then(function() {
        ...
        function renderTogglesCap(host, g2) {
          ...
          pctInp.onchange = function() {
            ...
            api("/set", { method: "POST", body: JSON.stringify({ key: "recallColdFactorPercent", value: String(v2) }) }).then(function() {
          ...
          api("/inject/preview").then(function(r7) {
            var txt = r7 && r7.text || "";
            if (!txt) {
          ...
          host.appendChild(UI.item(
            ...
            UI.select([
              ...
              api("/set", { method: "POST", body: JSON.stringify({ key: "deepSleep.failPolicy", value: v2 }) }).then(function() {
                status2("\u2713 \u6DF1\u7761\u672A\u6D88\u5316\u7B56\u7565 = " + v2);
              }).catch(fail2);
          ...
          var roundsInput = UI.input(String(gVal("deepSleepFailMaxRounds", 3)), function(raw) {
            ...
            api("/set", { method: "POST", body: JSON.stringify({ key: "deepSleep.failPolicyMaxRounds", value: String(n6) }) }).then(function() {
        ...
        function renderTogglesModelVec(host) {
          ...
          function refreshVecZone() {
            api("/vector/status2").then(function(s22) {
              vzone.textContent = "";
              ...
              sw.addEventListener("change", function() {
                api("/embed/config", { method: "POST", body: JSON.stringify({ embedEnabled: sw.checked }) }).then(function() {
              ...
              saveBtn.addEventListener("click", function() {
                ...
                api("/embed/config", { method: "POST", body: JSON.stringify({ embedBaseUrl: uInp.value.trim(), embedModel: mSel.value || curModel, embedApiKeyEnv: kInp.value.trim() || "EMBED_API_KEY" }) }).then(function() {
              ...
              var clearBtn = UI.button("\u6E05\u7F13\u5B58\u91CD\u5EFA", function() {
                return api("/vector/cache/clear", { method: "POST", body: "{}" }).then(function(r7) {
        ...
        function renderTogglesModelLlm(host) {
          ...
          function renderLlmSelect(container, keyP, keyM, label, desc) {
            ...
            sel.addEventListener("change", function() {
              ...
              api("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
          ...
          api("/llm/models").then(function(r7) {
            hostModels = r7 && r7.models || [];
            llmCard.textContent = "";
            return api("/distill/config").then(function(d3) {
        ...
        function renderTogglesSched(host, g2) {
          ...
          FUS_TIERS.forEach(function(tier) {
            ...
            cell.onclick = function() {
              api("/set", { method: "POST", body: JSON.stringify({ key: "recallFusion", value: tier[0] }) }).then(function() {
          ...
          function distillSave(patch, onFail) {
            return api("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
          ...
          api("/distill/config").then(function(d3) {
            ...
            pendBtn.addEventListener("click", function() {
              ...
              api("/distill/run", { method: "POST", body: "{}" }).then(function(rr) {
        ...
        function renderViewRoots(view, rootListWrap) {
          ...
          btn.onclick = function() {
            ...
            if (!p4) return;
            api("/set_root", { method: "POST", body: JSON.stringify({ path: p4 }) }).then(function() {
              input.value = "";
              status2("\u2713 \u6839\u76EE\u5F55\u5DF2\u542F\u7528");
              refreshCurrentView2();
            }).catch(fail2);
          ...
          function draw(r7) {
            ...
            r7.roots.forEach(function(root) {
              ...
              if (root.id === r7.active) useBtn.disabled = true;
                ...
                api("/set_root", { method: "POST", body: JSON.stringify({ path: root.path }) }).then(function() {
        ...
        function renderViewYaml(view, ta, saveRow) {
          ...
          api("/config/recent").then(function(r7) {
        ...
        function openMemoryNote(pointer, autoSection, returnRender) {
          if (!pointer) {
            status2("\u8BE5\u6761\u76EE\u65E0 notes \u8DF3\u8F6C\u76EE\u6807");
            return;
          }
          var rel = String(pointer).split("\xA7")[0].trim();
          if (!/^notes\/[a-z]+\.md$/.test(rel)) {
            status2("\u6307\u9488\u76EE\u6807\u975E notes \u767D\u540D\u5355\uFF1A" + pointer);
            return;
          }
          memoryViewScroll = refs.view.scrollTop;
          noteReturnRender = returnRender || null;
          api("/memory/sections?rel=" + encodeURIComponent(rel)).then(function(r7) {
            if (!r7 || !r7.present) {
              status2(r7 && r7.error || "\u5C0F\u8282\u4E0D\u53EF\u7528");
              return;
            }
            Fold.clear("note:");
        ...
        function renderPersona(view, data) {
          ...
          if (!data || !data.present || !Derive.has(data.indexes)) {
            status2(data && data.error || "\u8BB0\u5FC6\u5E93\u753B\u50CF\u4E0D\u53EF\u7528");
            return;
          }
          ...
          pair.forEach(function(f3, idx) {
            ...
            if (idx === 0) {
              right.push(UI.button("\u538B\u7F29\u753B\u50CF", function() {
                status2("\u753B\u50CF\u538B\u7F29\uFF08\u6DF1\u5EA6\u7761\u7720\u5F52\u7EB3\uFF09\u89E6\u53D1\u4E2D\u2026");
                return api("/deepsleep/trigger", { method: "POST", body: "{}" }).then(function(rr) {
                  status2(rr && rr.ok ? "\u2713 \u5DF2\u89E6\u53D1\u6DF1\u7761\u5F52\u7EB3\uFF08\u9AD8\u5206\u91CD\u590D\u6761\u76EE\u5C06\u6298\u53E0\u4E3A\u7D22\u5F15\u9879\uFF09" : "\u26A0 \u89E6\u53D1\u5931\u8D25\uFF1A" + (rr && rr.error || ""));
                });
              }, {
                async: true,
                busyText: "\u538B\u7F29\u4E2D\u2026",
        ...
        function mmNotesChips(ctx) {
          ...
          (data.notes || []).forEach(function(nf) {
            ...
            chip.addEventListener("click", function() {
              memoryViewScroll = view.scrollTop;
        ...
        var memoryViewScroll = 0;
        var noteReturnRender = null;
          ...
          back.addEventListener("click", function() {
            ...
            api("/memory/overview").then(function(r7) {
              ...
              requestAnimationFrame(function() {
                view.scrollTop = memoryViewScroll;
              });
            }).catch(fail2);
          });
        ...
        function renderViewSettings(view) {
          ...
          UI.pageHead("\u8BBE\u7F6E", "\u754C\u9762\u504F\u597D\u4E0E\u9AD8\u7EA7\u64CD\u4F5C\u3002\u914D\u7F6E\u539F\u6587\uFF08YAML\uFF09\u4E0E\u884C\u7EA7\u7F16\u8F91\u6536\u5728\u6B64\u5904\uFF0C\u914D\u98CE\u9669\u63D0\u793A\u3002", {
            ...
            actions: [UI.button("\u5BFC\u51FA\u5FEB\u7167", function() {
              return api("/config").then(function(c5) {
                var snap = {
          ...
          api("/deepsleep/config").then(function(cfg) {
            ...
            dsAdv.appendChild(makeToggle("enableDeepSleep", "\u542F\u7528\u6DF1\u5EA6\u7761\u7720\u81EA\u52A8\u5F52\u7EB3 enableDeepSleep", "\u5168\u90E8\u4F1A\u8BDD\u505C\u6EDE \u2265 \u9608\u503C\u540E\u81EA\u52A8\u63D0\u70BC\u539F\u5219\u5C42\uFF08\u5173\u95ED = \u6682\u505C\uFF0C\u7B49\u4E8E\u539F\u300C\u6682\u505C\u5230\u660E\u5929\u300D\uFF09\u3002", !!run.enableDeepSleep, function(key, sw) {
              api("/deepsleep/config", { method: "POST", body: JSON.stringify({ enableDeepSleep: sw.checked }) }).then(function() {
                status2("\u2713 \u5DF2\u4FDD\u5B58\uFF08\u91CD\u8F7D\u751F\u6548\uFF09");
              }).catch(function(e8) {
                fail2(e8);
                sw.checked = !sw.checked;
        ...
        function dsNumber(name, desc, initial, min, max, unit, encode, key) {
          ...
          range.addEventListener("change", function() {
            ...
            api("/deepsleep/config", { method: "POST", body: JSON.stringify(o9) }).then(function() {
        ...
        function renderRunExtras(view) {
          ...
          api("/reconcile").then(function(r7) {
            rw.textContent = "";
            if (!r7 || !r7.active) {
        ...
        function renderDeepSleep(view) {
          ...
          api("/deepsleep").then(function(r7) {
            if (!r7.active) {
            ...
            var scRun = UI.button("\u8FD0\u884C\u81EA\u68C0", function() {
              return api("/selfcheck/run", { method: "POST", body: "{}" }).then(function(rr) {
            ...
            api("/selfcheck").then(function(s4) {
              scBox.textContent = "";
              if (!s4 || !s4.active) {
        ...
        function ShoucangSettingsSection() {
          var h3 = slotReact.createElement;
