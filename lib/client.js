...
`;
  ...
  var Fold2 = /* @__PURE__ */ (function() {
    ...
    return {
      ...
      toggle: function(key, dflt) {
        return Fold2.set(key, !Fold2.get(key, dflt));
      },
  ...
  var UI = {
    ...
    fold: function(opts) {
      ...
      function act() {
        ...
        paint(Fold2.toggle(o9.key, dflt));
      }
      head.onclick = act;
      if (!isMore) {
  ...
  function openMemoryNote(pointer, autoSection, returnRender) {
    if (!pointer) {
      status("\u8BE5\u6761\u76EE\u65E0 notes \u8DF3\u8F6C\u76EE\u6807");
      return;
    }
    var rel = String(pointer).split("\xA7")[0].trim();
    if (!/^notes\/[a-z]+\.md$/.test(rel)) {
      status("\u6307\u9488\u76EE\u6807\u975E notes \u767D\u540D\u5355\uFF1A" + pointer);
      return;
    }
    appState.memoryViewScroll = refs.view.scrollTop;
    appState.noteReturnRender = returnRender || null;
    api("/memory/sections?rel=" + encodeURIComponent(rel)).then(function(r7) {
      if (!r7 || !r7.present) {
        status(r7 && r7.error || "\u5C0F\u8282\u4E0D\u53EF\u7528");
        return;
      }
      Fold.clear("note:");
      renderNoteSections(refs.view, r7);
      if (autoSection) {
        refs.view.querySelectorAll("[data-fold-key]").forEach(function(h3) {
    ...
    pair.forEach(function(f3, idx) {
      ...
      if (idx === 0) {
        right.push(UI.button("\u538B\u7F29\u753B\u50CF", function() {
          ...
          return api("/deepsleep/trigger", { method: "POST", body: "{}" }).then(function(rr) {
            status(rr && rr.ok ? "\u2713 \u5DF2\u89E6\u53D1\u6DF1\u7761\u5F52\u7EB3\uFF08\u9AD8\u5206\u91CD\u590D\u6761\u76EE\u5C06\u6298\u53E0\u4E3A\u7D22\u5F15\u9879\uFF09" : "\u26A0 \u89E6\u53D1\u5931\u8D25\uFF1A" + (rr && rr.error || ""));
          });
        }, {
          async: true,
          busyText: "\u538B\u7F29\u4E2D\u2026",
      ...
      factory: function(require2) {
        ...
        function contractOf(path) {
          ...
          if (!appState.contractByPath) {
            ...
            (CONTRACT.routes || []).forEach(function(r7) {
        ...
        function api2(path, opts) {
          ...
          if (pre) {
            ...
            Log2.warn("\u5951\u7EA6\u9884\u68C0\u672A\u901A\u8FC7\uFF1A" + pre.detail + "\uFF08\u672C\u5730\u62E6\u622A\uFF0C\u672A\u53D1\u51FA\u8BF7\u6C42\uFF09", ctx);
          ...
          return fetch(BASE + path, Object.assign({ headers: { "content-type": "application/json" } }, o9)).then(function(r7) {
            return r7.json().then(function(j2) {
              ...
              Log2.info(ctx.method + " " + path + " \u2713 " + ctx.ms + "ms", ctx);
              return j2;
            });
          }).catch(function(e8) {
            if (!e8.__ctx) e8.__ctx = ctx;
            endBusy();
            Log2.error(ctx.method + " " + path + " \u2717 " + (e8 && e8.message ? e8.message : String(e8)), ctx);
            throw e8;
          });
        }
        ...
        function status2(msg, level) {
          ...
          if (msg) Log2.add(lv, msg);
        }
        function fail2(e8, ctx) {
          ...
          if (!c5) Log2.error(err.message, { where: null, stack: rec.stack });
          return rec;
        }
        function apiCtx(path, opts, label) {
          ...
          return api2(path, o9).then(function(r7) {
            ...
            Log2.info((o9.method || "GET") + " " + path + " \u2713 " + (Date.now() - t0) + "ms", ctx);
            return r7;
          }).catch(function(e8) {
        ...
        function flushFolds() {
          ...
          q.forEach(function(t6) {
            try {
              ...
              Log2.warn("\u6298\u53E0\u6536\u53E3\u5931\u8D25\uFF1A" + (e8 && e8.message ? e8.message : e8));
            }
          });
          return q.length;
        }
        ...
        function ovMorningCard() {
          ...
          api2("/memory/overview").then(function(d3) {
        ...
        function ovTimelineCard() {
          ...
          Promise.all([
            api2("/memory/overview").catch(function() {
              return {};
            }),
            api2("/deepsleep").catch(function() {
              return {};
            })
          ]).then(function(rs) {
            var d3 = rs[0] || {}, sl = rs[1] || {};
        ...
        function ovCriteriaCard() {
          ...
          api2("/criteria").then(function(c5) {
            var o9 = c5 || {};
        ...
        function ovQuickCard() {
          ...
          row.appendChild(UI.button("\u6D4B\u8BD5\u5D4C\u5165\u8FDE\u901A", function() {
            ...
            return api2("/embed/config").then(function(c5) {
        ...
        function renderViewOverview(view) {
          ...
          ops.appendChild(opCard("\u7ACB\u5373\u84B8\u998F", "\u904D\u5386\u6839\u4F1A\u8BDD\u84B8\u998F\uFF0C\u643A\u5E26 pending \u5019\u9009\u56DE\u6D41\uFF1B\u7B49\u4EF7\u4E8E\u7B49\u4F1A\u8BDD\u7A7A\u95F2\u81EA\u52A8\u89E6\u53D1\u3002", "POST /distill/run", "\u84B8\u998F", function() {
            return apiCtx("/distill/run", { method: "POST", body: JSON.stringify({}) }, "\u84B8\u998F").then(function(r7) {
              status2(r7 && r7.ok ? "\u2713 " + (r7.note || "\u84B8\u998F\u5B8C\u6210") : "\u26A0 " + (r7 && r7.note || "\u672A\u89E6\u53D1\uFF1A\u6839\u4F1A\u8BDD\u6D3B\u8DC3\u4E2D\u4F1A\u8DF3\u8FC7\uFF0C\u7B49\u95F2\u7F6E\u81EA\u52A8\u8DD1"));
              refreshCurrentView2();
            });
          ...
          api2("/memory/overview").then(function(r7) {
            ...
            if (mf) {
              ...
              if (refs2.navHealth) refs2.navHealth(pct === null ? "\u6B63\u5E38" : Derive.capKind(pct) !== "ended" ? "\u6C34\u4F4D\u504F\u9AD8" : "\u6B63\u5E38", pct === null ? "ended" : Derive.capKind(pct));
            }
          ...
          api2("/mcl/status").then(function(m3) {
          ...
          api2("/deepsleep").then(function(d3) {
            var st = d3 || {};
          ...
          Promise.all([
            api2("/get_root").catch(function() {
              return {};
            }),
            api2("/mcl/status").catch(function() {
              return {};
            }),
            api2("/inject/stats").catch(function() {
              return {};
            }),
            api2("/vector/status2").catch(function() {
              return {};
            })
          ]).then(function(rs) {
        ...
        function numSetting(name, desc, val, key, unit, step) {
          ...
          inp.onchange = function() {
            ...
            api2("/set", { method: "POST", body: JSON.stringify({ key, value: v2 }) }).then(function() {
              status2("\u2713 " + key + " = " + v2);
            }).catch(fail2);
          };
        ...
        function renderTogglesInject(host, view, parsed, g2) {
          ...
          PERSONA_TIERS.forEach(function(tier, i7) {
            ...
            cell.onclick = function() {
              api2("/set", { method: "POST", body: JSON.stringify({ key: "injection.persona", value: tier[0] }) }).then(function() {
                status2("\u2713 persona \u6863\u4F4D = " + tier[1]);
          ...
          SWITCH_KEYS.forEach(function(it) {
            ...
            host.appendChild(makeToggle(it[0], it[1], it[2], cur, function(key, sw) {
              api2("/toggle", { method: "POST", body: JSON.stringify({ key }) }).then(function() {
                status2("\u2713 \u5DF2\u5207\u6362 " + key);
              }).catch(function(e8) {
                fail2(e8);
          ...
          LEVEL_TIERS.forEach(function(tier, i7) {
            ...
            cell.onclick = function() {
              api2("/set", { method: "POST", body: JSON.stringify({ key: "injection.level", value: tier[0] }) }).then(function() {
                status2("\u2713 injection.level = " + tier[0]);
        ...
        function renderTogglesCap(host, g2) {
          ...
          pctInp.onchange = function() {
            ...
            api2("/set", { method: "POST", body: JSON.stringify({ key: "recallColdFactorPercent", value: String(v2) }) }).then(function() {
              status2("\u2713 recallColdFactorPercent = " + v2 + "%");
            }).catch(fail2);
          };
          ...
          api2("/inject/preview").then(function(r7) {
            var txt = r7 && r7.text || "";
            if (!txt) {
          ...
          host.appendChild(UI.item(
            ...
            UI.select([
              ...
              api2("/set", { method: "POST", body: JSON.stringify({ key: "deepSleep.failPolicy", value: v2 }) }).then(function() {
                status2("\u2713 \u6DF1\u7761\u672A\u6D88\u5316\u7B56\u7565 = " + v2);
              }).catch(fail2);
          ...
          var roundsInput = UI.input(String(gVal("deepSleepFailMaxRounds", 3)), function(raw) {
            ...
            api2("/set", { method: "POST", body: JSON.stringify({ key: "deepSleep.failPolicyMaxRounds", value: String(n6) }) }).then(function() {
              status2("\u2713 \u5206\u7EA7\u7B56\u7565\u8FDE\u8D25\u4E0A\u9650 = " + n6 + " \u8F6E");
            }).catch(fail2);
        ...
        function renderTogglesModelVec(host) {
          ...
          function refreshVecZone() {
            api2("/vector/status2").then(function(s22) {
              vzone.textContent = "";
              ...
              sw.addEventListener("change", function() {
                api2("/embed/config", { method: "POST", body: JSON.stringify({ embedEnabled: sw.checked }) }).then(function() {
                  status2("\u2713 \u5411\u91CF " + (sw.checked ? "\u5F00" : "\u5173") + "\uFF08\u91CD\u8F7D\u540E\u751F\u6548\uFF09");
                }).catch(function(e8) {
                  fail2(e8);
                  sw.checked = !sw.checked;
                });
              ...
              saveBtn.addEventListener("click", function() {
                ...
                api2("/embed/config", { method: "POST", body: JSON.stringify({ embedBaseUrl: uInp.value.trim(), embedModel: mSel.value || curModel, embedApiKeyEnv: kInp.value.trim() || "EMBED_API_KEY" }) }).then(function() {
                  status2("\u2713 \u5DF2\u4FDD\u5B58\uFF08\u91CD\u8F7D\u540E\u751F\u6548\u2014\u2014\u82E5\u6362\u4E86\u670D\u52A1/\u6A21\u578B\u8BF7\u70B9\u300C\u6E05\u7F13\u5B58\u91CD\u5EFA\u300D\uFF09");
              ...
              var clearBtn = UI.button("\u6E05\u7F13\u5B58\u91CD\u5EFA", function() {
                return api2("/vector/cache/clear", { method: "POST", body: "{}" }).then(function(r7) {
                  status2("\u2713 \u5411\u91CF\u7F13\u5B58\u5DF2\u6E05" + (r7 && r7.removed ? "\uFF08\u5220\u9664 " + r7.removed + "\uFF09" : "") + "\u2014\u2014\u4E0B\u6B21\u53EC\u56DE\u6309\u5F53\u524D\u6A21\u578B\u81EA\u52A8\u91CD\u5D4C");
                });
        ...
        function renderTogglesModelLlm(host) {
          ...
          function renderLlmSelect(container, keyP, keyM, label, desc) {
            ...
            sel.addEventListener("change", function() {
              ...
              api2("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
                status2("\u2713 " + label + " \u5DF2\u8BBE" + (v2 ? "\uFF1A" + v2 : "\uFF08\u8DDF\u968F\u4E3B\u6A21\u578B\uFF09") + "\u2014\u2014\u91CD\u8F7D\u540E\u751F\u6548");
              }).catch(fail2);
            });
            rebuild();
          ...
          api2("/llm/models").then(function(r7) {
            hostModels = r7 && r7.models || [];
            llmCard.textContent = "";
            return api2("/distill/config").then(function(d3) {
        ...
        function renderTogglesSched(host, g2) {
          ...
          FUS_TIERS.forEach(function(tier) {
            ...
            cell.onclick = function() {
              api2("/set", { method: "POST", body: JSON.stringify({ key: "recallFusion", value: tier[0] }) }).then(function() {
                status2("\u2713 recallFusion = " + tier[0] + "\uFF08\u9700\u91CD\u8F7D\u63D2\u4EF6\u751F\u6548\uFF09");
          ...
          function distillSave(patch, onFail) {
            return api2("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
              status2("\u2713 \u5DF2\u5199\u5165 " + Object.keys(patch).join(",") + "\uFF08\u91CD\u8F7D\u540E\u751F\u6548\uFF09");
            }).catch(function(e8) {
              fail2(e8);
              if (onFail) onFail();
            });
          ...
          api2("/distill/config").then(function(d3) {
            ...
            pendBtn.addEventListener("click", function() {
              ...
              api2("/distill/run", { method: "POST", body: "{}" }).then(function(rr) {
                pendBtn.disabled = false;
                pendBtn.textContent = "\u7ACB\u5373\u84B8\u998F\u4E00\u6B21";
                if (rr && rr.ok) status2("\u2713 " + (rr.note || "\u84B8\u998F\u5B8C\u6210"));
                else status2("\u26A0 " + (rr && rr.note || "\u84B8\u998F\u672A\u89E6\u53D1") + "\u2014\u2014\u6839\u4F1A\u8BDD\u6D3B\u8DC3\u4E2D\u4F1A\u8DF3\u8FC7\uFF0C\u7B49\u95F2\u7F6E\u81EA\u52A8\u8DD1");
              }).catch(function(e8) {
                pendBtn.disabled = false;
                pendBtn.textContent = "\u7ACB\u5373\u84B8\u998F\u4E00\u6B21";
                fail2(e8);
        ...
        function renderViewRoots(view, rootListWrap) {
          ...
          btn.onclick = function() {
            ...
            if (!p4) return;
            api2("/set_root", { method: "POST", body: JSON.stringify({ path: p4 }) }).then(function() {
              input.value = "";
              status2("\u2713 \u6839\u76EE\u5F55\u5DF2\u542F\u7528");
              refreshCurrentView2();
            }).catch(fail2);
          ...
          function draw(r7) {
            ...
            r7.roots.forEach(function(root) {
              ...
              if (root.id === r7.active) useBtn.disabled = true;
                ...
                api2("/set_root", { method: "POST", body: JSON.stringify({ path: root.path }) }).then(function() {
                  status2("\u2713 \u5DF2\u542F\u7528 " + root.name);
                  refreshCurrentView2();
                }).catch(fail2);
              };
        ...
        function renderViewYaml(view, ta, saveRow) {
          ...
          api2("/config/recent").then(function(r7) {
        ...
        function renderCognitionReport(view, mode) {
          api2("/cognition/report").then(function(r7) {
            if (!r7 || !r7.ok) return;
            var host = view;
            var box = view;
        ...
        function renderMemoryExpanded(view, data) {
          ...
          if (!data || !data.present) {
            status2(data && data.error || "\u8BB0\u5FC6\u5E93\u4E0D\u53EF\u7528");
            return;
          }
          var memoryFile = null;
          ...
          if (refs2.navHealth) {
            ...
            refs2.navHealth(navPct === null ? "\u6B63\u5E38" : Derive.capKind(navPct) !== "ended" ? "\u6C34\u4F4D\u504F\u9AD8" : "\u6B63\u5E38", navPct === null ? "ended" : Derive.capKind(navPct));
          }
          ...
          mmSuiteZone(ctx);
          mmGrowthDelta(ctx);
          status2("\u8BB0\u5FC6 \xB7 MEMORY " + (memoryFile ? Derive.num(memoryFile.chars) + "/" + Derive.num(memoryFile.cap) + " \xB7 " + Derive.count(memoryFile.lines) + " \u884C" : "\u4E0D\u53EF\u7528") + " \xB7 \u84B8\u998F " + (ds ? Derive.num(ds.runs || 0) + " \u6B21" : "\u2014"));
          flushFolds();
        }
          ...
          if (data.pending && data.pending.count) {
            ...
            (data.pending.recent || []).forEach(function(p22) {
              ...
              okBtn.addEventListener("click", function() {
                api2("/memory/approve", { method: "POST", body: JSON.stringify({ pendingFile: fname }) }).then(function() {
                  status2("\u2713 \u5DF2\u6279\u51C6 " + fname + "\uFF08\u79FB .processed\uFF0C\u5185\u5BB9\u7531\u84B8\u998F\u6B63\u5E38\u5165\u518C\uFF09");
                }).catch(fail2);
              });
              var rmBtn = UI.button("\u5FFD\u7565", function() {
                return api2("/memory/approve", { method: "POST", body: JSON.stringify({ pendingFile: fname }) }).then(function() {
                  status2("\u5DF2\u5FFD\u7565 " + fname);
                });
        ...
        function mmNotesChips(ctx) {
          ...
          (data.notes || []).forEach(function(nf) {
            ...
            chip.addEventListener("click", function() {
              ...
              api2("/memory/sections?rel=" + encodeURIComponent(nf.rel)).then(function(r7) {
            ...
            if (Derive.has(suite.notes)) {
              ...
              suite.notes.forEach(function(nf) {
                ...
                chip.addEventListener("click", function() {
                  appState.memoryViewScroll = view.scrollTop;
                  appState.noteReturnRender = null;
                  api2("/memory/sections?rel=" + encodeURIComponent(nf.rel) + "&root=suite").then(function(r7) {
                    renderNoteSections2(view, r7);
                  }).catch(fail2);
                });
        ...
        function renderNoteSections2(view, data) {
          ...
          status2(data.rel + " \xB7 " + Derive.count(data.sections) + " \u9876\u5C42\u5C0F\u8282\uFF08\u6811\u72B6\uFF0C\u70B9\u51FB\u9010\u5C42\u5C55\u5F00\uFF1B\u7F16\u8F91\u5728\u8282\u70B9\u7EC6\u8282\uFF09");
        }
        function editNoteSection(data, sec, view) {
          ...
          saveBtn.addEventListener("click", function() {
            ...
            if (!next) {
              status2("\u6B63\u6587\u4E0D\u80FD\u4E3A\u7A7A\u2014\u2014\u5982\u9700\u6E05\u7A7A\u8BF7\u7528\u5220\u9664");
              return;
            }
            saveBtn.disabled = true;
            saveBtn.textContent = "\u4FDD\u5B58\u4E2D\u2026";
            api2("/memory/section-edit", { method: "POST", body: JSON.stringify({ rel: data.rel, section: sec.title, newBody: next }) }).then(function() {
              status2("\u2713 \xA7" + sec.title + " \u6B63\u6587\u5DF2\u4FDD\u5B58\uFF08write_gate \u901A\u8FC7\uFF09");
              api2("/memory/sections?rel=" + encodeURIComponent(data.rel) + (data.root === "suite" ? "&root=suite" : "")).then(function(r7) {
                renderNoteSections2(view, r7);
              }).catch(fail2);
            }).catch(function(e8) {
              saveBtn.disabled = false;
        ...
        function renderArchBody(view, safeFail) {
          ...
          var ops = el("div", "sc-opgrid");
          ops.appendChild(opCard("\u5185\u5BB9\u73AF\u4E0E\u53F0\u8D26", "\u4E94\u73AF KPI \u4E0E\u73AF\u4E8B\u4EF6\u5BF9\u8D26 + \u7EDF\u4E00\u53F0\u8D26\u6309 type \u5206\u5E03\uFF08\u7F3A `at` \u884C\u6570 = \u4FE1\u5C01\u5B8C\u6574\u6027\uFF09\u3002", "GET /rings \xB7 /arch/observability", "\u770B\u89C2\u6D4B", function() {
            tb.select("obs");
          ...
          api2("/arch/records").then(function(r7) {
            pRec.textContent = "";
            ...
            api2("/arch/graph").then(function(g2) {
              pObs.textContent = "";
          ...
          api2("/arch/observability").then(function(r7) {
            pObs.textContent = "";
          ...
          api2("/arch/assembly").then(function(r7) {
            pAsm.textContent = "";
            ...
            c5.body.appendChild(UI.item(
              ...
              UI.select(
                ...
                function(v2) {
                  api2("/set", { method: "POST", body: JSON.stringify({ key: "storeMode", value: v2 }) }).then(function(res) {
                    status2(res && res.ok ? "\u2713 storeMode = " + v2 + "\uFF08\u5DF2\u5199 scheduler.json\uFF09" : "\u26A0 \u672A\u751F\u6548");
                    renderArchBody(view, safeFail);
                  }).catch(function() {
                    status2("\u26A0 storeMode \u5199\u5165\u5931\u8D25\uFF08\u679A\u4E3E\u6216\u767D\u540D\u5355\u62D2\u7EDD\uFF09", "error");
                  });
                },
                "\u5B58\u50A8\u6A21\u5F0F"
              ),
          ...
          function renderMclKnobs() {
            pMcl.textContent = "";
            api2("/mcl/config").then(function(r7) {
              pMcl.textContent = "";
              ...
              var save = function(key, val) {
                var patch = {};
                patch[key] = val;
                api2("/mcl/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
                  status2("\u2713 " + key + " = " + val + "\uFF08\u5DF2\u5199\u5165 scheduler.json\uFF0C\u91CD\u8F7D\u540E\u751F\u6548\uFF09");
                  renderMclKnobs();
                }).catch(fail3);
              };
              var lim = r7.limits || {};
        ...
        function renderViewObserve(view) {
          ...
          UI.pageHead("\u8FD0\u884C\u89C2\u6D4B", "\u6267\u884C\u8FDB\u5EA6\u3001\u8C03\u7528\u65E5\u5FD7\u3001\u9519\u8BEF\u5B9A\u4F4D\u4E0E\u5173\u952E\u6307\u6807\u3002\u65E5\u5FD7\u4FDD\u7559\u6700\u8FD1 500 \u6761\uFF0C\u9519\u8BEF\u5E26\u7AEF\u70B9/\u53C2\u6570/\u5806\u6808\uFF0C\u4FBF\u4E8E\u5B9A\u4F4D\u800C\u975E\u53EA\u5269\u4E00\u884C\u63D0\u793A\u3002", {
            ...
            actions: [
              UI.button("\u5BFC\u51FA", function() {
                ...
                status2("\u2713 \u89C2\u6D4B\u6570\u636E\u5DF2\u5BFC\u51FA\uFF08" + logsAll.length + " \u6761\u65E5\u5FD7\uFF09");
            ...
            UI.button("\u6D4B\u8BD5\u8FDE\u63A5", function() {
              ...
              return api2("/embed/config").then(function(c5) {
                ...
                return apiCtx("/embed/test", {
                  ...
                  Log2.info("\u5D4C\u5165\u670D\u52A1\u8FDE\u901A\u6027\u6D4B\u8BD5" + (r7 && r7.error ? "\u5931\u8D25\uFF1A" + r7.error : "\u901A\u8FC7"));
                });
              }).catch(function(e8) {
          ...
          row.appendChild(UI.button("\u6309\u884C\u7F16\u8F91", function() {
            ...
            return apiCtx("/memory/edit", { method: "POST", body: JSON.stringify({ file, line, newText: nt }) }, "\u884C\u7EA7\u7F16\u8F91").then(function() {
              advRes.textContent = "\u2713 \u5DF2\u6539\u5199\u8BE5\u884C";
              Log2.warn("\u884C\u7EA7\u7F16\u8F91\u5DF2\u6267\u884C\uFF08\u53EF\u80FD\u9700\u540C\u6B65\u7D22\u5F15\uFF09\uFF1A" + file);
            }).catch(function(e8) {
          ...
          row.appendChild(UI.button("\u6309\u884C\u5220\u9664", function() {
            ...
            return apiCtx("/memory/remove", { method: "POST", body: JSON.stringify({ file, line }) }, "\u884C\u7EA7\u5220\u9664").then(function() {
              advRes.textContent = "\u2713 \u5DF2\u5220\u9664\u8BE5\u884C";
              Log2.warn("\u884C\u7EA7\u5220\u9664\u5DF2\u6267\u884C\uFF08\u53EF\u80FD\u9700\u540C\u6B65\u7D22\u5F15\uFF09\uFF1A" + file);
            }).catch(function(e8) {
              advRes.textContent = "\u2717 " + e8.message;
            });
        ...
        function renderViewSettings(view) {
          ...
          UI.pageHead("\u8BBE\u7F6E", "\u754C\u9762\u504F\u597D\u4E0E\u9AD8\u7EA7\u64CD\u4F5C\u3002\u914D\u7F6E\u539F\u6587\uFF08YAML\uFF09\u4E0E\u884C\u7EA7\u7F16\u8F91\u6536\u5728\u6B64\u5904\uFF0C\u914D\u98CE\u9669\u63D0\u793A\u3002", {
            ...
            actions: [UI.button("\u5BFC\u51FA\u5FEB\u7167", function() {
              return api2("/config").then(function(c5) {
                var snap = {
          ...
          api2("/deepsleep/config").then(function(cfg) {
            var run = cfg.running || {};
            dsAdv.appendChild(makeToggle("enableDeepSleep", "\u542F\u7528\u6DF1\u5EA6\u7761\u7720\u81EA\u52A8\u5F52\u7EB3 enableDeepSleep", "\u5168\u90E8\u4F1A\u8BDD\u505C\u6EDE \u2265 \u9608\u503C\u540E\u81EA\u52A8\u63D0\u70BC\u539F\u5219\u5C42\uFF08\u5173\u95ED = \u6682\u505C\uFF0C\u7B49\u4E8E\u539F\u300C\u6682\u505C\u5230\u660E\u5929\u300D\uFF09\u3002", !!run.enableDeepSleep, function(key, sw) {
              api2("/deepsleep/config", { method: "POST", body: JSON.stringify({ enableDeepSleep: sw.checked }) }).then(function() {
                status2("\u2713 \u5DF2\u4FDD\u5B58\uFF08\u91CD\u8F7D\u751F\u6548\uFF09");
              }).catch(function(e8) {
                fail2(e8);
                sw.checked = !sw.checked;
            ...
            dsAdv.appendChild(dsNumber("\u505C\u6EDE\u9608\u503C deepSleepIdleMs", "\u5168\u90E8\u4F1A\u8BDD\u65E0\u6D3B\u52A8\u6301\u7EED\u6EE1\u6B64\u6BEB\u79D2\u6570\u624D\u89E6\u53D1\uFF08\u9ED8\u8BA4 3 \u5C0F\u65F6\uFF09\u3002", Math.round((run.deepSleepIdleMs || 108e5) / 6e4), 10, 720, "\u5206\u949F", function(m3) {
              return m3 * 6e4;
            }, "deepSleepIdleMs"));
            dsAdv.appendChild(dsNumber("\u63A2\u6D4B\u53D1\u8D77\u5EF6\u8FDF deepSleepProbeAfterMs", "running \u65E0\u4E8B\u4EF6\u6301\u7EED\u6B64\u6BEB\u79D2\u540E\u53D1\u8D77\u8F93\u51FA\u589E\u957F\u63A2\u6D4B\uFF08\u9ED8\u8BA4 3 \u5C0F\u65F6\uFF09\u3002", Math.round((run.deepSleepProbeAfterMs || 108e5) / 6e4), 10, 720, "\u5206\u949F", function(m3) {
              return m3 * 6e4;
            }, "deepSleepProbeAfterMs"));
            dsAdv.appendChild(dsNumber("\u63A2\u6D4B\u91C7\u6837\u95F4\u9694 deepSleepProbeWindowMs", "\u4E24\u8F6E\u91C7\u6837\u4E4B\u95F4\u7684\u95F4\u9694\uFF08\u9ED8\u8BA4 60 \u79D2\uFF09\u3002", Math.round((run.deepSleepProbeWindowMs || 6e4) / 1e3), 5, 600, "\u79D2", function(s4) {
              return s4 * 1e3;
        ...
        function renderSuite(view, data) {
          ...
          UI.pageHead("\u63D2\u4EF6\u96C6\u5408", "suite \u88C5\u914D\u77E9\u9635\u7531 targets.ts \u7684 suiteAssemblyMatrix() \u5355\u4E00\u5B9E\u73B0\uFF1B\u9762\u677F\u4E0E scheduler \u5171\u7528\u3002", {
            ...
            actions: [UI.button("\u91CD\u65B0\u88C5\u914D", function() {
              refreshCurrentView2();
              status2("\u5DF2\u6309\u6CE8\u5165\u5668 registry + profiles \u91CD\u65B0\u6838\u88C5\u914D");
            }, { title: "\u91CD\u53D6\u88C5\u914D\u77E9\u9635\uFF08/suite\uFF09" })]
          });
        ...
        function dsNumber(name, desc, initial, min, max, unit, encode, key) {
          ...
          range.addEventListener("change", function() {
            ...
            api2("/deepsleep/config", { method: "POST", body: JSON.stringify(o9) }).then(function() {
              status2("\u2713 " + name + " = " + range.value + " " + unit + "\uFF08\u91CD\u8F7D\u751F\u6548\uFF09");
            }).catch(fail2);
          });
        ...
        function renderRunExtras(view) {
          ...
          api2("/reconcile").then(function(r7) {
            rw.textContent = "";
            if (!r7 || !r7.active) {
        ...
        function renderDeepSleep(view) {
          ...
          api2("/deepsleep").then(function(r7) {
            if (!r7.active) {
            ...
            (function() {
              ...
              var distCard = UI.card("\u7761\u7720\u72B6\u6001\u5206\u5E03", {
                ...
                right: [el("span", "sc-src", "GET /deepsleep"), UI.button("\u7ACB\u5373\u8FDB\u5165\u6DF1\u7761", function() {
                  status2("\u6DF1\u5EA6\u7761\u7720\u5F52\u7EB3\u4E2D\u2026");
                  return api2("/deepsleep/trigger", { method: "POST", body: "{}" }).then(function(rr) {
                    status2(rr.ok ? "\u2713 \u5DF2\u89E6\u53D1\u5F52\u7EB3\uFF08\u89C1\u65E5\u5FD7\uFF09" : "\u26A0 \u89E6\u53D1\u5931\u8D25\uFF1A" + (rr.error || ""));
                  });
            ...
            var scRun = UI.button("\u8FD0\u884C\u81EA\u68C0", function() {
              return api2("/selfcheck/run", { method: "POST", body: "{}" }).then(function(rr) {
                status2("\u2713 \u81EA\u68C0\u5B8C\u6210\uFF1A" + (rr.verdict || "?"));
            ...
            api2("/selfcheck").then(function(s4) {
              scBox.textContent = "";
              if (!s4 || !s4.active) {
        ...
        function show(name) {
          ...
          if (refs2.view) {
            ...
            refs2.view.setAttribute("role", "region");
            if (vv) refs2.view.setAttribute("aria-label", vv[1] + "\uFF08" + vv[3] + "\uFF09");
          }
          refs2.navItems.forEach(function(it) {
            it.el.classList.toggle("active", it.name === name);
          });
          refs2.view.textContent = "";
          var _hs = document.getElementById("scpanl-headslot");
          if (_hs) _hs.textContent = "";
          UI.bumpHeadEpoch();
          appState.foldQueue.length = 0;
          refs2.view.scrollTop = 0;
          if (name === "overview") {
            renderViewOverview(refs2.view);
          } else if (name === "persona") {
            api2("/memory/overview").then(function(r7) {
              renderPersona(refs2.view, r7);
            }).catch(fail2);
          } else if (name === "memory") {
            api2("/memory/overview").then(function(r7) {
              renderMemoryExpanded(refs2.view, r7);
            }).catch(fail2);
          } else if (name === "suite") {
            api2("/suite").then(function(r7) {
              renderSuite(refs2.view, r7);
            }).catch(fail2);
            ...
            api2("/config").then(function(r7) {
              ...
              renderViewToggles(refs2.view, r7.parsed || {}, r7.global);
            }).catch(fail2);
          } else if (name === "deepsleep") {
            renderDeepSleep(refs2.view);
          } else if (name === "observe") {
            renderViewObserve(refs2.view);
            collectMetrics();
          } else if (name === "arch") {
            renderViewArch(refs2.view);
          } else if (name === "settings") {
            renderViewSettings(refs2.view);
          }
        }
        function renderConfigRaw(host) {
          ...
          renderViewRoots(rootSection, function(w2) {
            refs2.rootListWrap = w2;
          });
          renderViewYaml(yamlSection, ta, saveRow);
          host.appendChild(rootSection);
          host.appendChild(yamlSection);
          api2("/roots").then(function(r7) {
            if (renderViewRoots._draw) renderViewRoots._draw(r7);
          }).catch(fail2);
          if (saveRow._btn) {
            saveRow._btn.onclick = function() {
              api2("/save", { method: "POST", body: JSON.stringify({ text: ta.value }) }).then(function() {
                status2("\u2713 \u5DF2\u4FDD\u5B58\uFF0C\u539F\u6587\u4EF6\u5DF2\u5907\u4EFD\u4E3A .bak-*");
              }).catch(fail2);
            };
          }
          api2("/config").then(function(r7) {
            ta.value = r7.text || "";
            if (!r7.text) status2(r7.error === "no-active-root" ? "\u672A\u6FC0\u6D3B\u6839\u76EE\u5F55\u2014\u2014\u8BF7\u5728\u300C\u9AD8\u7EA7 \xB7 \u6839\u76EE\u5F55\u300D\u533A\u6DFB\u52A0\u3002" : r7.error || "");
          }).catch(fail2);
        }
        ...
        function restartPolling() {
          ...
          appState.pollTimer = setInterval(function() {
            ...
            if (Cfg.get("autoRefresh", true)) refreshCurrentView2();
          }, ms);
        }
        ...
        function buildModal(mask) {
          ...
          VIEWS.forEach(function(v2) {
            ...
            refs2.navItems.push({ name: v2[0], el: item });
          ...
          refs2.navHealth = function(stateText, kind, subText) {
          ...
          refs2.view = el("div", "sc-view");
          main.appendChild(refs2.view);
        ...
        function mount() {
          ...
          try {
            ...
            Log2.warn("\u7EC4\u4EF6\u5E93\u4E3B\u9898\u6CE8\u5165\u5931\u8D25\uFF1A" + (e8 && e8.message));
          }
        ...
        function applyCfgSideEffect(key) {
          try {
            ...
            Log2.warn("\u8BBE\u7F6E\u751F\u6548\u5931\u8D25\uFF08" + key + "\uFF09\uFF1A" + (e8 && e8.message));
          }
        }
        ...
        function apply(ctx) {
          ...
          if (SLOT_OK) {
            Log2.info("\u4FA7\u680F\u5165\u53E3\uFF1A\u5DF2\u6CE8\u518C\u5BBF\u4E3B\u63D2\u69FD sidebar.footer.action\uFF08\u4E0D\u6302 DOM \u76F4\u63D2\u5165\u53E3\uFF09");
          } else {
            Log2.info("\u4FA7\u680F\u5165\u53E3\uFF1A\u5BBF\u4E3B\u63D2\u69FD\u4E0D\u53EF\u7528\uFF08" + (reactEl ? "slots \u670D\u52A1\u7F3A\u5931" : "require('react') \u4E0D\u53EF\u7528") + "\uFF09\uFF0C\u56DE\u9000 DOM \u76F4\u63D2");
