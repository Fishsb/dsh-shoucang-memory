...
`;
  ...
  var systemLibrary = {
    ...
    resolver: (name, _family = "classic", variant = "solid") => {
      ...
      let svg = (_b2 = (_a8 = collection[name]) != null ? _a8 : icons.regular[name]) != null ? _b2 : icons.regular["circle-question"];
      if (svg) {
        return dataUri(svg);
      }
      return "";
  ...
  var WaIcon = class extends WebAwesomeElement {
    constructor() {
      ...
      this.resolveIcon = async (url, library2) => {
        ...
        try {
          ...
          if (((_a8 = svg == null ? void 0 : svg.tagName) == null ? void 0 : _a8.toLowerCase()) !== "svg") return CACHEABLE_ERROR;
    ...
    updated(changedProperties) {
      ...
      const svg = (_a8 = this.shadowRoot) == null ? void 0 : _a8.querySelector("svg");
      if (svg) {
    ...
    setActiveTab(tab, options) {
      ...
      if (tab !== this.activeTab && !tab.disabled) {
        ...
        this.panels.forEach((el) => {
          var _a8;
          return el.active = el.name === ((_a8 = this.activeTab) == null ? void 0 : _a8.panel);
        });
        if (["top", "bottom"].includes(this.placement)) {
        ...
        function renderTogglesCap(host, g2) {
          ...
          pctInp.onchange = function() {
            ...
            api("/set", { method: "POST", body: JSON.stringify({ key: "recallColdFactorPercent", value: String(v2) }) }).then(function() {
              status("\u2713 recallColdFactorPercent = " + v2 + "%");
            }).catch(fail);
          };
            ...
            api("/vector/status2").then(function(s22) {
              ...
              sw.addEventListener("change", function() {
                api("/embed/config", { method: "POST", body: JSON.stringify({ embedEnabled: sw.checked }) }).then(function() {
                  status("\u2713 \u5411\u91CF " + (sw.checked ? "\u5F00" : "\u5173") + "\uFF08\u91CD\u8F7D\u540E\u751F\u6548\uFF09");
                }).catch(function(e8) {
                  fail(e8);
                  sw.checked = !sw.checked;
                });
              ...
              saveBtn.addEventListener("click", function() {
                ...
                api("/embed/config", { method: "POST", body: JSON.stringify({ embedBaseUrl: uInp.value.trim(), embedModel: mSel.value || curModel, embedApiKeyEnv: kInp.value.trim() || "EMBED_API_KEY" }) }).then(function() {
                  status("\u2713 \u5DF2\u4FDD\u5B58\uFF08\u91CD\u8F7D\u540E\u751F\u6548\u2014\u2014\u82E5\u6362\u4E86\u670D\u52A1/\u6A21\u578B\u8BF7\u70B9\u300C\u6E05\u7F13\u5B58\u91CD\u5EFA\u300D\uFF09");
              ...
              var clearBtn = UI.button("\u6E05\u7F13\u5B58\u91CD\u5EFA", function() {
                return api("/vector/cache/clear", { method: "POST", body: "{}" }).then(function(r7) {
                  status("\u2713 \u5411\u91CF\u7F13\u5B58\u5DF2\u6E05" + (r7 && r7.removed ? "\uFF08\u5220\u9664 " + r7.removed + "\uFF09" : "") + "\u2014\u2014\u4E0B\u6B21\u53EC\u56DE\u6309\u5F53\u524D\u6A21\u578B\u81EA\u52A8\u91CD\u5D4C");
                });
          ...
          function renderLlmSelect(container, keyP, keyM, label, desc) {
            ...
            sel.addEventListener("change", function() {
              ...
              api("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
                status("\u2713 " + label + " \u5DF2\u8BBE" + (v2 ? "\uFF1A" + v2 : "\uFF08\u8DDF\u968F\u4E3B\u6A21\u578B\uFF09") + "\u2014\u2014\u91CD\u8F7D\u540E\u751F\u6548");
              }).catch(fail);
            });
            rebuild();
        ...
        function renderTogglesSched(host, g2) {
          ...
          function distillSave(patch, onFail) {
            return api("/distill/config", { method: "POST", body: JSON.stringify(patch) }).then(function() {
              status("\u2713 \u5DF2\u5199\u5165 " + Object.keys(patch).join(",") + "\uFF08\u91CD\u8F7D\u540E\u751F\u6548\uFF09");
            }).catch(function(e8) {
              fail(e8);
              if (onFail) onFail();
            });
        ...
        function renderSuite(view, data) {
          ...
          UI.pageHead("\u63D2\u4EF6\u96C6\u5408", "suite \u88C5\u914D\u77E9\u9635\u7531 targets.ts \u7684 suiteAssemblyMatrix() \u5355\u4E00\u5B9E\u73B0\uFF1B\u9762\u677F\u4E0E scheduler \u5171\u7528\u3002", {
            ...
            actions: [UI.button("\u91CD\u65B0\u88C5\u914D", function() {
              refreshCurrentView();
              status("\u5DF2\u6309\u6CE8\u5165\u5668 registry + profiles \u91CD\u65B0\u6838\u88C5\u914D");
            }, { title: "\u91CD\u53D6\u88C5\u914D\u77E9\u9635\uFF08/suite\uFF09" })]
          });
        ...
        function dsNumber(name, desc, initial, min, max, unit, encode, key) {
          ...
          range.addEventListener("change", function() {
            ...
            api("/deepsleep/config", { method: "POST", body: JSON.stringify(o9) }).then(function() {
              status("\u2713 " + name + " = " + range.value + " " + unit + "\uFF08\u91CD\u8F7D\u751F\u6548\uFF09");
            }).catch(fail);
          });
            ...
            (function() {
              ...
              var distCard = UI.card("\u7761\u7720\u72B6\u6001\u5206\u5E03", {
                ...
                right: [el("span", "sc-src", "GET /deepsleep"), UI.button("\u7ACB\u5373\u8FDB\u5165\u6DF1\u7761", function() {
                  status("\u6DF1\u5EA6\u7761\u7720\u5F52\u7EB3\u4E2D\u2026");
                  return api("/deepsleep/trigger", { method: "POST", body: "{}" }).then(function(rr) {
                    status(rr.ok ? "\u2713 \u5DF2\u89E6\u53D1\u5F52\u7EB3\uFF08\u89C1\u65E5\u5FD7\uFF09" : "\u26A0 \u89E6\u53D1\u5931\u8D25\uFF1A" + (rr.error || ""));
                  });
          ...
          if (saveRow._btn) {
            saveRow._btn.onclick = function() {
              api("/save", { method: "POST", body: JSON.stringify({ text: ta.value }) }).then(function() {
                status("\u2713 \u5DF2\u4FDD\u5B58\uFF0C\u539F\u6587\u4EF6\u5DF2\u5907\u4EFD\u4E3A .bak-*");
              }).catch(fail);
            };
          }
          api("/config").then(function(r7) {
            ta.value = r7.text || "";
            if (!r7.text) status(r7.error === "no-active-root" ? "\u672A\u6FC0\u6D3B\u6839\u76EE\u5F55\u2014\u2014\u8BF7\u5728\u300C\u9AD8\u7EA7 \xB7 \u6839\u76EE\u5F55\u300D\u533A\u6DFB\u52A0\u3002" : r7.error || "");
          }).catch(fail);
        }
