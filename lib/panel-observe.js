...
function reconcileRoute(d, _req, res) {
    try {
...
function maturationScanRoute(d, _req, res) {
    try {
...
function selfcheckRunRoute(d, _req, res) {
    try {
        sendJson(res, 200, runSelfCheckNow(d));
    }
    catch (e) {
        sendJson(res, 500, { error: String(e).slice(0, 200) });
    }
