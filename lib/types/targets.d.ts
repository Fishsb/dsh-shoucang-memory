 ...
 */
export declare function isProfileRow(line: string): boolean;
/**
 ...
 */
export declare function recallKeyOf(text: string): string;
/**
 ...
 */
export declare function isRealUserEvent(e: unknown): boolean;
