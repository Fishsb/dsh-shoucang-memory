 ...
 *     panel-arch.ts    架构观测与调节面（5 端点 · 2026-09-13 架构重构后新增：记录层/断言图/观测/装配/MCL 旋钮）
...
export declare function applyPanel(ctx: Context, config: Config, comp?: CompositionHandles): void;
