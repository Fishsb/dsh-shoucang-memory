        ...
        try {
            ...
            try {
                ...
                if (stop === 'completed' && out) {
                    ...
                    recordEpisode({ sid, intent: intent.slice(0, 120), route, outcome: disp.targetLib, added: disp.added, rejected: disp.rejected, failed: disp.failed, lib: disp.targetLib });
                    if (route !== 'discard')
