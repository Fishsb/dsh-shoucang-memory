 ...
 */
export function guardContextText(text) {
 ...
 */
export function wouldThrowHostInterpolation(text) {
    if (typeof text !== 'string' || !text.includes(TEMPLATE_OPEN))
        return false;
...
//# sourceMappingURL=inject-guard.js.map