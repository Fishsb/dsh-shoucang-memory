...
export async function applyPrinciples(d, memRoot, out) {
    ...
    if (g2.ok)
        return commitAccepted(principlesPath, principlesTmp, acceptedItems, attempted, skipped, rejectedLines, log);
...
function commitAccepted(principlesPath, principlesTmp, acceptedItems, attempted, skipped, rejectedLines, log) {
