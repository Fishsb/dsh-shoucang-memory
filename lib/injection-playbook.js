...
export const MEMORY_PLAYBOOK_LINES = [
    '【守藏·三层判据（何时该做什么）】',
 ...
 */
export function playbookEnabled(suite) {
    try {
        const cfg = suite.read();
...
export function playbookCharCount() {
    return [...MEMORY_PLAYBOOK_LINES.join('\n')].length;
}
//# sourceMappingURL=injection-playbook.js.map