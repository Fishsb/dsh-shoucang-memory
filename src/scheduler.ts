...
export const Config: any = z.object({
  ...
  capUser: z.number().min(100).default(2000).description('USER.md 容量门（字符，写门强制；缺省 2000）'),
  capMemory: z.number().min(100).default(3000).description('MEMORY.md 容量门（字符，写门强制；缺省 3000）'),
