...
export const EVAL_CONFIG_KEYS = ['evalEnabled', 'evalBaseUrl', 'evalModel', 'evalApiKeyEnv', 'evalTier', 'evalEgressAllow'] as const

export const DISTILL_CONFIG_KEYS = ['enableDistill', 'idleWakeMs', 'minTurnChars', 'distillPrescan', 'llmProvider', 'llmModel', 'distillProvider', 'distillModel', 'distillEffort', 'sleepProvider', 'sleepModel', 'sleepEffort'] as const
